...
<body>
    <h1 class="header1">Added Cab List to Update</h1>
        ...
        <table border="1">
            ...
            <% } else { %>
                ...
                <tr>
                    ...
                    <td><a href="UpdateChosenCab.jsp?Cab_ID=<%= cab.getCab_ID() %>"><button class='read-more-button'>Update Cab</button></a></td>
                </tr>
                <% } %>
            <% } // End else block %>
        </table>
